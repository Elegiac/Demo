...
public class Test {
	...
	public static void main(String[] args) {
		...
		list3.stream().collect(Collectors.averagingInt(Integer::intValue));

		// 求和summingDouble/summingInt/summarizingLong
		list3.stream().collect(Collectors.summingInt(Integer::intValue));

		// 统计各项 summarizingDouble/summarizingInt/summarizingLong
		// 返回包含集合信息的对象(包含元素个数，总和，最小值，最大值，平均值)
		list3.stream().collect(Collectors.summarizingInt(Integer::intValue));
