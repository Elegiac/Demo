...
public class Import {
	...
	static String SQL_INSERT_NOVEL = "INSERT INTO t_novel (identification,createTime,category_id,novel_title,remark) VALUES (?,NOW(),?,?,?)";
	...
	public static void main(String[] args) {
		...
		for (File dir : target.listFiles()) {
			...
			living.executeUpdate(SQL_INSERT_NOVEL, novelId, "007006", novelName, "new");
